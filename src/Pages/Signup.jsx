...
<div></div>      )}
     ...
     <div className='py-8 text-[px] inline-flex text-gray-500 font-poppins font-medium gap-7'>
      ...
      <div>
          ...
          <></><button className='w-[240px] h-[60px] bg-orange-600  transition-all duration-300 hover:bg-Primary-Orange-200 font-poppins tracking-widest border-0 text-white px-6 py-2 rounded-full'>Sign Up</button>
