 ...
 function Dinner  () {
  ...
  return (
    <div>
       ...
       <p className='font-pacifico text-[40px] py-8 sm:text-left hover:text-orange-600'>Dinner Category</p>
        ...
        { data.map((recipe) => {
            return(
                <div>
                   ...
                   <p className='font-poppins text-[15px] px-[72px] mt-4 text-gray-500 font-semibold '>{recipe.strMeal}</p>
                    {/* </div> */}
                    {/* </SplideSlide> */}
                </div>
